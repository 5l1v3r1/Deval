package r1.deval.rt
{
  ...
  public class ImportStmt extends EmptyStmt
  {
	...
	public function ImportStmt(classes:Array, lineno:int, ts:TokenStream)
	{
	  super(lineno, ts);
	...
	override public function exec() : void
	{
	  ...
	  for each(cls in classes)
	  {
		try
		{
		  ...
		  if (x != null)
		  {
			if (x is Class) Env.importClass(x as Class, cls);
			else if (x is Function) Env.importFunction(cls, x as Function);
		  }
		  else
		  {
